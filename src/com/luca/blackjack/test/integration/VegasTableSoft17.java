...
public class VegasTableSoft17 {
	...
	public VegasTableSoft17(List<Object> inputs, List<Object> results) {
	...
	public static Collection<Object[]> data() {
		...
		File file0 = new File("data/test-data-v1.0-002.xml");
		...
		player1.addAll(Arrays.asList(70d, Result.LOST_BUSTED_OUT));
		List<Object> player2 = new ArrayList<Object>();
		player2.addAll(Arrays.asList(165d, Result.LOST_LOWER_SCORE));
		List<Object> player3 = new ArrayList<Object>();
		player3.addAll(Arrays.asList(115d, Result.LOST_LOWER_SCORE));
		List<Object> player4 = new ArrayList<Object>();
		player4.addAll(Arrays.asList(50d, Result.LOST_LOWER_SCORE));
		List<Object> player5 = new ArrayList<Object>();
		player5.addAll(Arrays.asList(110d, Result.LOST_BUSTED_OUT));
		List<Object> player6 = new ArrayList<Object>();
		player6.addAll(Arrays.asList(110d, Result.PUSH));
