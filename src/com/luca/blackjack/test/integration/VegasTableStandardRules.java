...
public class VegasTableStandardRules {
	...
	public VegasTableStandardRules(List<Object> inputs, List<Object> results) {
	...
	public static Collection<Object[]> data() {
		...
		player1.addAll(Arrays.asList(30d, Result.LOST_BUSTED_OUT));
		List<Object> player2 = new ArrayList<Object>();
		player2.addAll(Arrays.asList(155d, Result.LOST_LOWER_SCORE));
		List<Object> player3 = new ArrayList<Object>();
		player3.addAll(Arrays.asList(75d, Result.LOST_LOWER_SCORE));
		List<Object> player4 = new ArrayList<Object>();
		player4.addAll(Arrays.asList(35d, Result.PUSH));
		List<Object> player5 = new ArrayList<Object>();
		player5.addAll(Arrays.asList(70d, Result.LOST_LOWER_SCORE));
		List<Object> player6 = new ArrayList<Object>();
		player6.addAll(Arrays.asList(100d, Result.LOST_LOWER_SCORE));
		List<Object> player7 = new ArrayList<Object>();
		player7.addAll(Arrays.asList(85d, Result.WON_BLACKJACK));
		run.addAll(Arrays.asList(Card.KING_OF_SPADES, 20, player1,
