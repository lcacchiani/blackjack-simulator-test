...
public class DefaultPlayerGameStrategyV2 {
	...
	public DefaultPlayerGameStrategyV2(List<Card> cards, Move result) {
		this.cards = cards;
		this.result = result;
	}
	...
	public final void setup() {
		strategy = new com.luca.blackjack.strategy.game.DefaultPlayerGameStrategyV2();
	}
